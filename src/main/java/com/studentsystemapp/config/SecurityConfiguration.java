    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.authorizeHttpRequests(
                ...
                authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers("/enquiries/{id}/add").hasRole(UserRolesEnum.STUDENT.name())
                        .requestMatchers("/enquiries/{id}/respond").hasRole(UserRolesEnum.TEACHER.name())
                        .requestMatchers("/courses","/courses/{id}").authenticated()
                        .requestMatchers("/resources","/resources/{id}").authenticated()
                        .requestMatchers("/students","/students/{id}","/students/{id1}/tasks/{id2}/upload","/students/{id}/upload-picture").authenticated()
                        .requestMatchers("/tasks/{id}","/students/{id}/tasks").hasRole(UserRolesEnum.TEACHER.name())
